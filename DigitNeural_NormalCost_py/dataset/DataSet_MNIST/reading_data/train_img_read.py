...
import struct
images = open("/home/cookie98/Dhruvin/NeuralNetwork/DigitNeural_py/dataset/DataSet_MNIST/train-images-idx3-ubyte/data","rb")
lable = open("/home/cookie98/Dhruvin/NeuralNetwork/DigitNeural_py/dataset/DataSet_MNIST/train-labels-idx1-ubyte/data","rb")
im_read = images.read()
lb_read = lable.read()
