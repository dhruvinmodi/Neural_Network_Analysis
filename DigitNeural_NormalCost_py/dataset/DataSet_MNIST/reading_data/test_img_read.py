...
#			dataset[0] = ([0,2,0,......784],5)
#			dataset[1] = ([1,0,45,.....784],9)
#

import struct
images = open("/home/cookie98/Dhruvin/NeuralNetwork/DigitNeural_py/dataset/DataSet_MNIST/t10k-images-idx3-ubyte/data","rb")
lable = open("/home/cookie98/Dhruvin/NeuralNetwork/DigitNeural_py/dataset/DataSet_MNIST/t10k-labels-idx1-ubyte/data","rb")
im_read = images.read()
lb_read = lable.read()
images_write = open("test_images.csv","w")
lable_write = open("test_lable.csv","w")
temp = 0
j = 1
k = 0
for i in im_read:
...
images_write.close()
lable_write.close()
images = open("test_images.csv","r")
lable = open("test_lable.csv","r")
dataset = []
